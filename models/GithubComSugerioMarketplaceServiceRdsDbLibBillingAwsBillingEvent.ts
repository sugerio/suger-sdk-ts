...
export class GithubComSugerioMarketplaceServiceRdsDbLibBillingAwsBillingEvent {
    'action'?: string;
    'agreementID'?: string;
    'amount'?: number;
    ...
    static getAttributeTypeMap() {
        return GithubComSugerioMarketplaceServiceRdsDbLibBillingAwsBillingEvent.attributeTypeMap;
    }
